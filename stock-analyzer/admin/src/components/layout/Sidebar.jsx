...
import { 
  FiHome, FiGrid, FiBox, FiLayers, FiList, 
  FiUser, FiLogOut, FiUsers, FiShoppingCart, FiFileText, FiActivity
} from 'react-icons/fi';
...
export default function Sidebar() {
  ...
  const adminLinks = [
    ...
    { name: 'Billing (POS)', path: '/billing', icon: <FiShoppingCart /> },
    { name: 'Categories', path: '/categories', icon: <FiGrid /> },
    { name: 'Products', path: '/products', icon: <FiBox /> },
    { name: 'Stock Management', path: '/stock', icon: <FiLayers /> },
    { name: 'Stock Requests', path: '/requests', icon: <FiList /> },
    { name: 'Billing Logs', path: '/billing-logs', icon: <FiFileText /> },
    { name: 'Stock Logs', path: '/stock-logs', icon: <FiActivity /> },
    { name: 'Customer Logs', path: '/users', icon: <FiUsers /> },
  ];
